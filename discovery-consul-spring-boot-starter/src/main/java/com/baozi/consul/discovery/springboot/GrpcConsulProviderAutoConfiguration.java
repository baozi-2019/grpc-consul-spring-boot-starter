package com.baozi.consul.discovery.springboot;
...
import com.baozi.consul.discovery.springboot.processor.GrpcConsulProviderRoundProcessor;
import com.baozi.consul.discovery.springboot.processor.GrpcExceptionProcessor;
...
public class GrpcConsulProviderAutoConfiguration {
    ...
    public GrpcConsulProviderRoundProcessor grpcConsulProviderRoundProcessor(
        ...
        ErrorServerInterceptor errorServerInterceptor = new ErrorServerInterceptor(grpcExceptionProcessor.getMethodMap(), consulProperties.getDiscovery().getService().getName());
